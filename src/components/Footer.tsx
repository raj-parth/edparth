...
import { Send, ExternalLink, BookOpen, Sparkles, Shield, FileText, AlertCircle, Mail } from 'lucide-react';
...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-16 border-t border-slate-200 bg-white text-slate-600">
            ...
            <ul className="space-y-2 text-xs font-medium">
              <li>
                <button
                  ...
                  className="hover:text-slate-900 hover:underline cursor-pointer flex items-center gap-1.5 text-slate-600"
                >
      ...
      {/* Production Legal & Compliance Modal */}
      <LegalModal
